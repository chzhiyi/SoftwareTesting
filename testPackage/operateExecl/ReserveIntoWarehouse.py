...
# 建立一个MySQL连接
connection = pymysql.connect (host="db.stg.helijia.com", port=6006, user = "hljtest_dev", passwd = "hljtest_dev123456", db = "hlj",)
...
for r in range(2, sheet.nrows):
      ...
      value = (instance_name, exp_190311, exp_190311_single, max181111,max180919,max180515,max180311,max171111,max170923,max170515,max170311)
      values.append(value)
